...
public class PostRepository {
    ...
    public void writeCommentToPost(String imageId, String comment) {
        Path commentsPath = Paths.get("src/main/resources/data/comments");
    ...
    public ArrayList<String[]> loadCommentsForPost(String imageId) {
        ...
        File commentDir = new File("src/main/resources/data/comments");
    ...
    public void writeLikeToPost(String imageId) {
        ...
        File likeDir = new File("src/main/resources/data/likes");
    ...
    public int loadLikesForPost(String imageId) {
        ...
        File commentDir = new File("src/main/resources/data/likes");
    ...
    public boolean isAlreadyLiked(String imageId, String username) {
        String likedImagePath = "src/main/resources/data/likes/" + imageId + "_likes.txt";
        String likesPath = "src/main/resources/data/likes/" + imageId + "_likes.txt";
    ...
    public void deleteLikeFromPost(String imageId) throws IOException {
        ...
        File temp = new File("src/main/resources/data/temp.txt");
    ...
    public void writeNotification(String imageId, String type) {
        ...
        try (BufferedWriter notificationWriter = Files.newBufferedWriter(Paths.get("src/main/resources/data", "notifications.txt"), StandardOpenOption.CREATE, StandardOpenOption.APPEND)) {
    ...
    public String getImagePath(String imageId) {
        ...
        File folder = new File("src/main/resources/img/uploaded/");
        if (folder.exists() && folder.isDirectory()) {
            File[] files = folder.listFiles();
            if (files != null) {
                for (File file : files) {
                    for (String ext : extensions) {
                        if (file.getName().startsWith(imageId) && file.getName().endsWith(ext)) {
                            System.out.println("Found image: " + file.getAbsolutePath()); // Debugging
